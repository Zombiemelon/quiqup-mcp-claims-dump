...
<required_reading>
@/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/references/ai-frameworks.md
@/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/agents/gsd-eval-planner.md for instructions.
