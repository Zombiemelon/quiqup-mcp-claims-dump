...
- **Global scope**: `/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/notes/`)
...
2. Glob `/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/notes/` — works in any directory
