...
```bash
INIT=$(node "/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
