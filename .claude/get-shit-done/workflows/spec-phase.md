...
```bash
INIT=$(node "/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/templates/spec.md.
