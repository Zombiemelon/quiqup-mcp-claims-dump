...
INSTALL_JS_GLOBAL="/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
