...
```
Agent(
  prompt="Read /Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/templates/VALIDATION.md`
