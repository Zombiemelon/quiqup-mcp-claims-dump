...
<template>
@/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/svetoslavdimitrov/Documents/quiqup-mcp/.claude/get-shit-done/workflows/diagnose-issues.md
